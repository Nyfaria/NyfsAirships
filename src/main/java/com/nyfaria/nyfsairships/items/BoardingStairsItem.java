...
public class BoardingStairsItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        List<BlockShipEntity> vv = world.getEntities(NyfsAirships.BLOCK_SHIP_ENTITY_ENTITY_TYPE,new AABB(result.getLocation().add(-10,-10,-10),result.getLocation().add(10,10,10)), LivingEntity::isAlive);
        if(vv.size()>0)
        {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag context) {
        ...
        tooltip.add(new TranslatableComponent("boardingstairs.nyfsairships.tooltip"));
    }
}
